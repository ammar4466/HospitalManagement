...
var GetContactDetails = function () {
    ...
    content += 'If you want to modify or add new features, you can always contact us at, <br />'
        + _WhatsAppElement + '<br />'
        + 'ðŸ“¢ Telegram: <a href="#" id="linkTelegram" onclick="CopyToClipboard(this)">shahed71bd</a><br />'
        + 'ðŸ“¢ Skype: <a href="#" id="linkSkype" onclick="CopyToClipboard(this)">shahedatomap</a><br />'
        + 'ðŸ™ Email: <a href="#" id="linkEmail" onclick="CopyToClipboard(this)">shahedbddev@gmail.com</a><br />'
        + 'â™¾ï¸ Web: <a href="https://netspeedm.com/" target="_blank">Zero Byte Solutions</a>';
...
var WhatsAppElement = function () {
    var elements = '';
    elements = '<span>ðŸ“² WhatsApp: </span><a href="https://wa.me/8801674411603" target="_blank">8801674411603</a>';
    return elements;
}

var BuyNowElement = function () {
    var elements = '';
    elements += '<a href="https://1.envato.market/OR5o6N" target="_blank">'
